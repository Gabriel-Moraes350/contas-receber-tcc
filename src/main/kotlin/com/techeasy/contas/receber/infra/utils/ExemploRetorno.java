...
import com.techeasy.contas.receber.domain.retorno.Protocolo;
import com.techeasy.contas.receber.domain.retorno.Sumario;
...
public class ExemploRetorno {
	...
	public static void main(String[] args) throws IOException {
		...
		File fileExemplo = new File("resource/arquivoRetorno/EXAMPLE.RET");
